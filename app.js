...
app.get('/posts', (req, res) => {
    // const dados = [
    //     {titulo: "Post 1", conteudo: "Conteúdo post 1", autor: 'autor 1'},
    //     {titulo: "Post 2", conteudo: "Conteúdo post 2", autor: 'autor 2'},
    //     {titulo: "Post 3", conteudo: "Conteúdo post 3", autor: 'autor 3'}
    // ];
